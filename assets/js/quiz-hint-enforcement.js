...
(function($) {
    ...
    function showCorrectAnswerIndicator() {
        ...
        if (hintMessage) {
            // Replace the hint message content with correct answer indicator - keep same positioning
            hintMessage.style.background = '#d4edda';
            hintMessage.style.border = '2px solid #28a745';
